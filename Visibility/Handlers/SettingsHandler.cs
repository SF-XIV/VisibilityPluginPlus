...
public class SettingsHandler
{
	...
	private void InitializeSettingActions()
	{
		...
		// Hrothgar -> All
		this.settingActions[nameof(TerritoryConfig.HideHrothgar)] = this.CreateToggleAction(
			(config, v, t) => config.HideHrothgar.ToggleBool(v, t),
			() => VisibilityPlugin.Instance.ShowHrothgars(ContainerType.All)
		);
		...
		// Hrothgar -> Combat
		this.settingActions[nameof(TerritoryConfig.HideHrothgarInCombat)] = this.CreateToggleAction(
			(config, v, t) => config.HideHrothgarInCombat.ToggleBool(v, t),
			() => VisibilityPlugin.Instance.ShowHrothgars(ContainerType.All)
		);
		...
		// Hrothgar -> FC
		this.settingActions[nameof(TerritoryConfig.ShowCompanyHrothgar)] = this.CreateToggleAction(
			(config, v, t) => config.ShowCompanyHrothgar.ToggleBool(v, t),
			() => VisibilityPlugin.Instance.ShowHrothgars(ContainerType.Company)
		);
		...
		// Hrothgar -> FC
		this.settingActions[nameof(TerritoryConfig.ShowPartyHrothgar)] = this.CreateToggleAction(
			(config, v, t) => config.ShowPartyHrothgar.ToggleBool(v, t),
			() => VisibilityPlugin.Instance.ShowHrothgars(ContainerType.Company)
		);
		...
		// Hrothgar -> Friend (What??)
		this.settingActions[nameof(TerritoryConfig.ShowFriendHrothgar)] = this.CreateToggleAction(
			(config, v, t) => config.ShowFriendHrothgar.ToggleBool(v, t),
			() => VisibilityPlugin.Instance.ShowHrothgars(ContainerType.Friend)
		);
		...
		// Special Case: ShowDeadHrothgar (no afterToggleAction)
		this.settingActions[nameof(TerritoryConfig.ShowDeadHrothgar)] = this.CreateToggleAction((config, v, t) =>
				config.ShowDeadHrothgar.ToggleBool(v, t)
		// No specific afterToggleAction needed
		);
	}
}
